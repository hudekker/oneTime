    ...
    if (
      ...
      (o += "a=" + s),
        ...
        e.sendEncodingParameters[0].rtx &&
          ((o += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + s), (o += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
    }
    return (
    ...
    (H.writeMediaSection = function (e, t, r, n) {
      ...
      if (
        ...
        (i += "a=" + o),
          ...
          e.sendEncodingParameters[0].rtx &&
            ((i += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + o), (i += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
      }
      return (
    ...
    if (
        ...
        ((r.mediaDevices.getUserMedia = function (e) {
          return (
            "object" == typeof e &&
              ...
              ((e = JSON.parse(JSON.stringify(e))), i(e.audio, "autoGainControl", "mozAutoGainControl"), i(e.audio, "noiseSuppression", "mozNoiseSuppression")),
            o(e)
          );
        }),
      ...
      if (n && n.prototype.applyConstraints) {
        ...
        n.prototype.applyConstraints = function (e) {
          return (
            "audio" === this.kind && "object" == typeof e && ((e = JSON.parse(JSON.stringify(e))), i(e, "autoGainControl", "mozAutoGainControl"), i(e, "noiseSuppression", "mozNoiseSuppression")),
            s.apply(this, [e])
          );
        };
      }
  ...
  var Ie,
    ...
    (Ie.prototype.isBrowserSupported = function () {
      ...
      return (
        ...
        ("chrome" === e ? t >= this.minChromeVersion : "firefox" === e ? t >= this.minFirefoxVersion : "safari" === e && !this.isIOS && t >= this.minSafariVersion)
      );
    }),
    ...
    Jt = (function (e) {
      function t(r, n) {
        ...
        return (
          ...
          (n = zt(
            { debug: 0, host: Fe.CLOUD_HOST, port: Fe.CLOUD_PORT, path: "/", key: t.DEFAULT_KEY, token: Fe.randomToken(), config: Fe.defaultConfig, referrerPolicy: "strict-origin-when-cross-origin" },
            n
          )),
          (o._options = n),
      ...
      return (
        ...
        (t.prototype.reconnect = function () {
          if (this.disconnected && !this.destroyed)
            qe.default.log("Attempting reconnection to server with ID ".concat(this._lastServerId)), (this._disconnected = !1), this._initialize(this._lastServerId);
          else {
